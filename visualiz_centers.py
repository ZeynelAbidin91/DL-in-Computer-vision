...
widgets = ["Comparing:", progressbar.Percentage(), " ", progressbar.Bar(),
            " ", progressbar.ETA()]
...
for(i, imageID) in enumerate(featuresDB["image_ids"]):
    # grab the rows for the features database and split them into keypoint and feature vectors
...
# close the feature database and progress bar
pbar.finish()
featuresDB.close()
